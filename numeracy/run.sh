...
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type bool_simple --fname $FNAME
echo "Generating logic data for bool of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type bool --fname $FNAME
echo "Generating logic data for algebraic_int of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type algebraic_int --fname $FNAME
echo "Generating logic data for algebraic_float of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type algebraic_float --fname $FNAME
echo "Generating logic data for var+algebraic_int of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type var+algebraic_int --fname $FNAME
echo "Generating logic data for var+algebraic_float of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type var+algebraic_float --fname $FNAME
echo "Generating logic data for var+comparative_int of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type var+comparative_int --fname $FNAME
echo "Generating logic data for var+comparative_float of size $N"
python gen_data.py --task logic --min 0 --max 99 -n $N -m 5 --type var+comparative_float --fname $FNAME